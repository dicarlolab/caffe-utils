...
weight_dir="/om/user/chengxuz/caffe_install/snapshot/alexnet_sp_${1}_${2}/_iter_200000.caffemodel"
...
python test.py --net=${net} --weights=${weight_dir} --dp-params=${dp_params} --preproc=${preproc}
