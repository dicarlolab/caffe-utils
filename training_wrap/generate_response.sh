...
weight_dir="/om/user/chengxuz/caffe_install/snapshot/alexnet_sp_${1}_${2}/_iter_${3}.caffemodel"

#save_address="test.hdf5"
save_address="/om/user/chengxuz/RDM_results/hvm_response/hdf5_file/caffe_alexnet_sp_${1}_${2}_${3}/"
mkdir -p ${save_address}

dp_params="{'data_path':'/om/user/chengxuz/RDM_results/data_cached_hdf5_un/data.raw','data_key':'data','label_path':'/om/user/chengxuz/my_meta_data/labels_for_images_cache_e86d39462641ebc8870926aa16629eae5ca11c78_random_0_hdf5/labels.hdf5','label_key':['labels'],'cache_type':'hdf5','batch_size':40,'val_len':5760}"
...
python test.py --net=${net} --weights=${weight_dir} --dp-params=${dp_params} --preproc=${preproc} --perm-flag=0 --save-file=${save_address}
